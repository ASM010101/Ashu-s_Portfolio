...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for ASHISH split effect
    const letters = useMemo(() => [
        { char: 'A', baseX: -1.15, splitDir: -1.8, delay: 0 },
        { char: 'S', baseX: -0.69, splitDir: -1.1, delay: 0 },
        { char: 'H', baseX: -0.23, splitDir: -0.4, delay: 0 },
        { char: 'I', baseX: 0.23, splitDir: 0.4, delay: 0 },
        { char: 'S', baseX: 0.69, splitDir: 1.1, delay: 0 },
        { char: 'H', baseX: 1.15, splitDir: 1.8, delay: 0 },
    ], []);

    // Tagline words for split effect
    const taglineWords = useMemo(() => [
        { text: '<', baseX: -1.15, splitDir: -1.8, delay: 0 },
        { text: 'applied', baseX: -0.65, splitDir: -1.0, delay: 0 },
        { text: 'ai', baseX: -0.05, splitDir: 0.0, delay: 0 },
        { text: 'engineer', baseX: 0.6, splitDir: 1.0, delay: 0 },
        { text: '/>', baseX: 1.18, splitDir: 1.8, delay: 0 },
    ], []);
