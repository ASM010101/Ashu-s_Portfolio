...
const FALLBACK_PROJECTS = [
    {
        ...
        description: 'Obstacle Detection in Path Planning for Unmanned Aerial Vehicles Based on YOLO. Published in IEEE (Jun 2024). Evaluates YOLO object detection efficiency and deployment constraints on resource-limited UAV platforms.',
    ...
    },
    {
        ...
        description: 'ICIP: An Integrated Approach for AI Image Generation Using Stable Diffusion. Published in Taylor & Francis ICICS 2025 (Corresponding Author). Combines ControlNet, IP-Adapter, and inpainting under IndiaAI Mission grant.',
    ...
    },
    {
        ...
        description: 'AI-powered KYC system for secure customer onboarding engineered for the Standard Chartered Hackathon, combining face verification with automated document validation workflows.',
    ...
    },
    {
        ...
        title: 'BARCLAYS ANOMALY ML',
        front: '/textures/gallery/bioprzod.webp',
        painted: '/textures/gallery/bioprzod_painted.webp',
        url: 'https://github.com/ASM010101',
        description: 'Financial-transaction anomaly-detection system engineered for the Barclays Hackathon; advanced to the final round using machine learning and transactional pattern data analytics.',
