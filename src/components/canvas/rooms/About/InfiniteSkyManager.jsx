    ...
    return (
        <group ref={groupRef} position={[0, 0, z]}>
            ...
            <Text
                ...
                fontStyle="italic"
            >
                "Building autonomous agents, speech AI
            </Text>
            ...
            <Text
                ...
                fontStyle="italic"
            >
                and scalable LLM neural architectures"
            </Text>
        </group>
    );
};
...
const AWARDS_DATA = {
    featured: {
        ...
        title: 'Fellowships & Education',
        items: [
            { label: 'IndiaAI Mission Research Fellow', date: 'Sep 2024 – Feb 2025', image: '/textures/about/FEATURED.webp', url: 'https://indiaai.gov.in' },
            { label: 'HyperVerge Nexus Research Fellow', date: 'Feb 2024 – Jun 2024', image: '/textures/about/FEATURED.webp', url: 'https://hyperverge.co' },
            { label: 'IIT Patna M.Tech in Artificial Intelligence', date: 'Jul 2026 – Jun 2028', image: '/textures/about/FEATURED.webp', url: 'https://www.iitp.ac.in' },
            { label: 'SRM IST B.Tech CSE AI & ML (CGPA 9.04)', date: 'Jun 2021 – Jun 2025', image: '/textures/about/FEATURED.webp', url: 'https://www.srmist.edu.in' },
        ],
        platformConfig: {
            label: 'FELLOWSHIPS',
            color: '#1a1a1a',
    ...
    sotd: {
        ...
        items: [
            { label: 'Obstacle Detection in Path Planning for UAVs Based on YOLO', date: 'IEEE Published Jun 2024', image: '/textures/about/SOTDAYYOUNGMULTIGSAP.webp', url: 'https://ieeexplore.ieee.org/document/10550335' },
            { label: 'ICIP: AI Image Generation Using Stable Diffusion', date: 'Taylor & Francis ICICS 2025', image: '/textures/about/SOTDAYYOUNGMULTICSSWINNER.webp', url: 'https://www.researchgate.net/publication/401880407_ICIP_An_integrated_approach_for_AI_image_generation_using_stable_diffusion' },
        ],
        platformConfig: {
            label: 'PUBLICATIONS',
            color: '#1a1a1a',
    ...
    sotm: {
        id: 'award-sotm',
        layout: 'certificate_grid',
        title: 'Experience & Deployments',
        items: [
            { label: 'Samespace SDE-1 AI/ML Engineer', date: 'Jul 2025 – Jun 2026', image: '/textures/about/FEATURED.webp', url: 'https://samespace.com' },
            { label: 'Online Video KYC System (Standard Chartered)', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/ASM010101' },
            { label: 'Financial Anomaly Detection (Barclays Finalist)', date: '2024', image: '/textures/about/FEATURED.webp', url: 'https://github.com/ASM010101' },
        ],
        platformConfig: {
            label: 'SYSTEMS',
            color: '#1a1a1a',
    ...
    other: {
        ...
        items: [
            { label: 'Oracle Cloud 2024 Generative AI Certified Professional', date: 'Oracle, 2025', image: '/textures/about/FEATURED.webp', url: 'https://education.oracle.com' },
        ],
        platformConfig: {
            label: 'HONORS',
            color: '#1a1a1a',
