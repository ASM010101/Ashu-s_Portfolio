...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'ASHISH', subtitle: '< applied ai engineer />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'HONORS', subtitle: 'HyperVerge Fellow • IndiaAI Fellow • IEEE Author' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'M.Tech AI @ IIT Patna • SDE-1 @ Samespace' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'LLMs • RAG • Speech AI • Multi-Agent Systems' },
];
