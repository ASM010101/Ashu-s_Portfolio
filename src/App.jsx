...
// Only preload essential entrance textures for initial view
const filteredEntrance = filterTexturesByDevice(ENTRANCE_TEXTURES, supportsHover);
filteredEntrance.forEach(path => useTexture.preload(path));
